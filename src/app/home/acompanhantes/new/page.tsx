    ...
    return (
        <div className='flex flex-col w-full flex-1 relative'>
            <section className="flex flex-1 flex-col px-4">
                ...
                <h1 className='text-3xl font-semibold my-12'>Cadastro de Acompanhante</h1>
                <form className="flex flex-col w-full mb-12 bg-gray-50 rounded-md p-4" onSubmit={
                    e => {
                        e.preventDefault()
                        handleSubmit(e)
                    }
                    ...
                    <div className='flex-col gap-5 w-full' style={{ display: formScreen == 'dados' ? 'flex' : 'none' }}>
                        ...
                        <fieldset className="flex flex-col md:flex-row gap-3">
                            <TextField
                                ...
                                size='small'
                                sx={{ flex: 0.5, backgroundColor: 'white' }}
                                select
                            >
